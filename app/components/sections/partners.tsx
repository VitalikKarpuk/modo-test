    ...
    >
      <div className="mx-auto max-w-7xl px-6 pt-8 md:pt-10 pb-4 flex items-center gap-3">
        ...
        <span className="font-mono text-[11px] tracking-widest uppercase text-fg-dim">
          Every network Modo supports
        </span>
        <div className="flex-1 h-px bg-line" />
      </div>

      <div className="absolute left-0 top-10 bottom-0 w-24 z-10 bg-gradient-to-r from-bg to-transparent pointer-events-none" />
      <div className="absolute right-0 top-10 bottom-0 w-24 z-10 bg-gradient-to-l from-bg to-transparent pointer-events-none" />

      <div className="flex items-center gap-12 md:gap-20 pt-4 pb-10 md:pb-12 marquee-track whitespace-nowrap">
        {[...PARTNERS, ...PARTNERS].map((p, i) => (
          <a
            ...
            rel="noreferrer"
            aria-label={p.name}
            className="partner-slot shrink-0 flex items-center"
          >
